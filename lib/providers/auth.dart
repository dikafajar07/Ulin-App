...
import 'package:mobile_ulin/pages/auth_page.dart';
...
class Authenticate with ChangeNotifier {
  ...
  Future<void> signup(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBx-HauVGgCdymRQ5kp4o75lfW4ghr_CWo");
  ...
  Future<void> login(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBx-HauVGgCdymRQ5kp4o75lfW4ghr_CWo");
